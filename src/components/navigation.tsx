...
export function Navigation() {
  ...
  const handleApproveRequest = async (requestId: string) => {
    try {
      ...
      // CRITICAL: Mark this request as deleted FIRST to prevent re-adding notifications
      ...
      // CRITICAL: Find and mark ALL notification IDs to delete IMMEDIATELY
      ...
      // CRITICAL: Remove from UI IMMEDIATELY to prevent flickering
      ...
      if (user?.id) {
        ...
        console.log(`[handleApproveRequest] Verification: deletedNotificationIdsRef has ${Array.from(deletedNotificationIdsRef.current).length} IDs`)
        console.log(`[handleApproveRequest] Verification: deletedRequestIdsRef has ${Array.from(deletedRequestIdsRef.current).length} IDs`)
